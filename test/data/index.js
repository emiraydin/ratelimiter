...
var l5 = new Limit("{sourceName}:global:daily", 86400, 4000),
	l6 = new Limit("{sourceName}:global:hourly", 3600, 2000),
	l7 = new Limit("{sourceName}:{userID}:daily", 86400, 500),
	l8 = new Limit("{sourceName}:{userID}:hourly", 3600, 100);
